...
connect('mongodb://localhost:27017/notapp')
    ...
    .then(() => {
        const pepinillo = new User({ name: 'Pepinillo', email: 'pepi@nillo.com', password: '123123123'})
        const alcachofa = new User({ name: 'Alcachofa', email: 'alca@chofa.com', password: '123123123'})
    ...
    .then(users => {
        ...
        const pepi1 = new Note({ user: pepinillo.id, date: new Date, text: 'hola, esta nota es blanca'})
        ...
        const alca3 = new Note({ user: alcachofa.id, color: 'black', text:'privadita nomas'})
