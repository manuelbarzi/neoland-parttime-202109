...
export default function Header({ onSearch }) {
    ...
    const handleSearch = event => {
        ...
        const query = event.target.q.value // parametro event accede a la propiedad target (del formulario), para acceder al valor del input
                    ...
                    <div className='lg:w-full py-5'>
                        <form onSubmit={handleSearch}>
                            ...
                            <div className="relative">
                                ...
                                <input name="q" type="search" id="default-search" className="block p-4 pl-10 w-full text-xl text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Spaces..." required="" />
                    ...
                    <div className="flex gap-12 justify-center items-center">
                        ...
                        {token ?
                            ...
                            <> <div class="inline-flex relative w-fit">
                                <div class="absolute inline-block -top-1/4 right-0 bottom-auto left-auto translate-x-2/4 -translate-y-1/2 rotate-0 skew-x-0 skew-y-0 scale-x-100 scale-y-100 py-1 px-2.5 text-xs leading-none text-center whitespace-nowrap align-baseline font-bold bg-principal-color text-white rounded-full z-10">connected</div>
                                <button onClick={loggedOut} type="button" class="cursor-pointer nav__font black text-xl">Log Out</button>
                            </div></>
