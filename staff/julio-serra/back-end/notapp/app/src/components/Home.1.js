            ...
            <div className="bg-cover h-screen bg-right bg-slate-200">
                    ...
                    <a href="/">
                        <nav className="flex justify-between items-center">
                            ...
                            <div className="gap-10 flex text-violet-700 text-xl">
                                <span><a className="flex gap-3 items-center hover:underline hover:underline-offset-8" onClick={handleLogout}>Logout <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <section className="bg-white container w-screen mx-auto mt-12 py-12 px-6">
                    <div className="grid justify-center">
                        ...
                        {notes ? <ul className="grid grid-cols-3 gap-6 pt-5">
                            {notes.map(note => <li className="bg-gray-100 p-6" key={note.id} > {note.text}</li>)}
                        </ul> : <p>no notes</p>}
