...
function App() {
  ...
  //     <Route path="login" element={<Login onRegisterClick={onRegister} onLoggedIn={onLogin} />} />
  //      <Route path="register" element={<Register onLoginClick={goToLogin} onRegistered={onRegister} />} /> 
  //      <Route pat="PostRegister" element={<PostRegister onLoginClick={goToLogin} />} />
  //   </Routes>
