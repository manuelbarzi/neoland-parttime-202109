...
class Detail extends Component {
    ...
    goToAddToCart = () => {
        try {
            addVehicleToCart(sessionStorage.token, this.state.vehicle.id) //en esta lógica si la cosa va bien no hace nada, sólo ctachería el error
                // .then // no hace falta porque no hace nada, si ha ido bien ahi se queda
    ...
    render() {
        ...
        if (this.state.vehicle)
            return <div>
                ...
                <Fav selected={this.state.vehicle.isFav} onClick={this.goToToggleFav} />
                <button onClick={this.goToAddToCart}>Add to cart</button>
