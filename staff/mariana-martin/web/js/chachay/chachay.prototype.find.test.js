...
var res = words.find(function (word) {
...
var res = numbers.find(function (number) {
    return number > 21
})
...
var name = 'Patrick'
var names = new Chachay('Ana', 'Pedro', 'Luis', 'Lola', 'María', 'José')
var res = names.find(function (name) {
    if (name !== names) {
        return undefined
    } else {
        return names
