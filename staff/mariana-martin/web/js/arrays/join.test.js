...
if (typeof res === 'string'
    ...
    var empty = [] //creo una var para guardar el array vacío porque un array no se puede comparar
    ...
    if (typeof res === 'string'
        ...
        && elements[6] === 'Ground'
        && elements[7] === 'Ether'
        && elements[8] === empty) //se creo una var, porque no se puede comparar un array, por que es objeto
        console.log('test ok')
    else
        console.error('test ko')
