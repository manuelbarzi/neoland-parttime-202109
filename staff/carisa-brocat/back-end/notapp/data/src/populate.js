...
connect('mongodb://localhost:27017/notapp')
    ...
    // .then(() => {
    //     const carycary = new User({ name: 'CaryCary', email: 'carycary@gmail.com', password: '12345678' })
    //     const ricardin = new User({ name: 'Ricardin', email: 'Ricardin@gmail.com', password: '12345678' })
    ...
    //     const notecary2 = new Note({ user: carycary.id, color: 'red', text: 'This is carycary private note' })

    //     const notericar1 = new Note({ user: ricardin.id, date: new Date, color: 'pink', public: true, text: 'This is a ricardin public note' })
    //     const notericar2 = new Note({ user: ricardin.id, color: 'black', text: 'This is ricardin private note' })
    ...
    .then(() => disconnect())
    .then(() => console.log('disconnect from db'))
