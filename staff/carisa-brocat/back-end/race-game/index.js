...
function getResult(car1, car2, car3) {
    ...
    else if (car1.position === car2.position === 100 && car1.position >= 100)
        return `tie ${car1.icon} ${car2.icon}`
    else if (car1.position === car3.position === 100 && car1.position >= 100)
        return `tie ${car1.icon} ${car3.icon}`
    else if (car2.position === car3.position === 100 && car2.position >= 100)
