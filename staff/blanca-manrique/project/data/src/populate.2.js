...
connect('mongodb://localhost:27017/projectdemo')
    ...
    .then(() => {
        ...
        const Silvia = new User({ username: 'silvia', email: 'silvia@qq.com', password: '121212' })

        return Promise.all([Blanca.save(), Alex.save(), Silvia.save()])
    })
    .then(users => {
    ...
    .then(products => {
        const [wineOpener, officeChair] = products
