...
//     return element.style.transform = translate(black.x, black.y)
// })
...
//Trayectorias cartas negras
var direction = 1

setInterval(function () {
    if (four.x > 2900 && queen.y > 1000 && jack.x > 700 && jack.y > 700 && king.y> 800)
        direction = -1
    if (four.x < 130 && queen.y < 20 && jack.x < 30 && jack.y < 30 && king.y <35)
        direction = 1
