...
const { registerUser, authenticateUser, retrieveUser, updateUser, deleteUser, createNote, updateNote, deleteNote, retrieveNotes, retrievePublicNotesFromUser } = require('logic')
...
connect('mongodb://localhost:27017/notapp')
    .then(() => {
        ...
        router.get('/users/:ownerId/notes', (req, res) => {
            try {
